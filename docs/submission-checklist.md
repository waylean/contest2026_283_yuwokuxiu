...
- [ ] Package name follows the official Chinese naming rule
- [ ] Introduction document is DOCX, PDF or PPTX
- [ ] Project source and official repository URL are included
- [ ] Demo is MP4 or MOV and no longer than five minutes
- [ ] Submission is uploaded before 2026-09-20
